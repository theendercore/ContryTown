...
object SettlementArgumentType {
    fun settlementArg(name: String = "name"): RequiredArgumentBuilder<ServerCommandSource, String> {
        return CommandManager.argument(name, StringArgumentType.string()).suggests(::listSuggestions)
    }

    @Throws(CommandSyntaxException::class)
    fun getSettlement(context: CommandContext<ServerCommandSource>, name: String = "name"): Settlement {
